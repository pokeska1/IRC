...
Если в сообщении неправильно указана команда и/или параметры, на этапе парсинга, сервер может выдать клиенту ошибку.
...
IRC-операторы, в отличие от остальных пользователей, имеют наивысшие права и собственные пароли. Чтобы произвести пользователю аутентификацию в качестве IRC-оператора, требуется выполнить команду [OPER](#oper).
